    ...
    <nav>
        <ul class="home__navigation--menu__wrapper">
            <li class="home__navigation--menu__items">
                <a class="home__navigation--menu__link" href="index-2.html">
                    <span class="home__navigation--menu__text">HOME</span>
            ...
            <li class="home__navigation--menu__items">
                <a class="home__navigation--menu__link" href="{{ url('about') }}">
                    <span class="home__navigation--menu__text">ABOUT</span>
            ...
            <li class="home__navigation--menu__items">
                <a class="home__navigation--menu__link" href="services.html">
                    <span class="home__navigation--menu__text">SERVICES</span>
            ...
            <li class="home__navigation--menu__items">
                <a class="home__navigation--menu__link" href="portfolio.html">
                    <span class="home__navigation--menu__text">PORTFOLIO</span>
            ...
            <li class="home__navigation--menu__items">
                <a class="home__navigation--menu__link" href="contact.html">
                    <span class="home__navigation--menu__text">CONTACT</span>
