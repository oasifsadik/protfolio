<div class="toggle__navigation">
    ...
    <ul class="toggle__nav--menu">
        <li class="toggle__nav--menu__items">
            <a class="toggle__nav--menu__link" href="{{ url('/') }}">
        ...
        <li class="toggle__nav--menu__items">
            <a class="toggle__nav--menu__link" href="{{ url('about') }}">
        ...
        <li class="toggle__nav--menu__items">
            <a class="toggle__nav--menu__link active" href="{{ url('services') }}">
        ...
        <li class="toggle__nav--menu__items">
            <a class="toggle__nav--menu__link" href="{{ url('protfolio') }}">
        ...
        <li class="toggle__nav--menu__items">
            <a class="toggle__nav--menu__link" href="{{ url('blog') }}">
        ...
        <li class="toggle__nav--menu__items">
            <a class="toggle__nav--menu__link" href="{{ url('contact') }}">
